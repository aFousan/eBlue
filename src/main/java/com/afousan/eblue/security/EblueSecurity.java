 ...
 */
package com.afousan.eblue.security;
 ...
 * @author aFousan
 */
public abstract class EblueSecurity {
    ...
    private static final ThreadLocal<UserInfo> user = new NamedThreadLocal<UserInfo>("eblue-id");
